...
export default function BrandNavigation() {
  ...
  return (
    <>
      {isRedirecting ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#070605c2] backdrop-blur-[2px]" role="status" aria-live="polite">
          <div className="flex items-center gap-3 rounded-xl border border-[#e0c8935e] bg-[#110f0ce8] px-5 py-4 shadow-2xl">
      ...
      <nav className="rounded-2xl border border-[#e0c8932f] bg-[linear-gradient(160deg,rgba(20,17,13,0.9),rgba(10,8,7,0.95))] p-6 shadow-[0_22px_42px_rgba(0,0,0,0.45)]" aria-label="Brand navigation">
        <div className="mb-4">
